/*
  ...
  - You are about to drop the column `statusStr` on the `Record` table. All the data in the column will be lost.
  - You are about to drop the column `statusStr` on the `WorkflowStep` table. All the data in the column will be lost.
  - You are about to drop the column `typeStr` on the `WorkflowStep` table. All the data in the column will be lost.
  ...
  - Added the required column `status` to the `WorkflowStep` table without a default value. This is not possible if the table is not empty.
  - Added the required column `type` to the `WorkflowStep` table without a default value. This is not possible if the table is not empty.

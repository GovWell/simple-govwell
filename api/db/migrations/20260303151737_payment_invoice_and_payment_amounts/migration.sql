/*
  ...
  - Added the required column `invoiceAmount` to the `Payment` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Payment" ("createdAt", "id", "workflowStepId") SELECT "createdAt", "id", "workflowStepId" FROM "Payment";
DROP TABLE "Payment";
